...
const SkeletonCard = () => (
  ...
  >
    <div className='h-52 max-md:h-40 max-sm:h-36 max-xs:h-32 mb-5 max-sm:mb-2 rounded bg-skin-skeleton'></div>
    <div className='flex flex-col items-center gap-1.5 max-xs:gap-0.5'>
      <div className='h-3 max-xs:h-2 rounded-full bg-skin-skeleton w-1/2 mb-1'></div>
      <div className='h-2 max-xs:h-1 rounded-full bg-skin-skeleton w-full'></div>
      <div className='h-2 max-xs:h-1 rounded-full bg-skin-skeleton w-full'></div>
      <div className='h-2 max-xs:h-1 rounded-full bg-skin-skeleton w-full'></div>
    </div>
