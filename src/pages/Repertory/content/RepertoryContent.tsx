import { EmptyRepertory, Table } from '../components';
...
export const RepertoryContent = () => {
  ...
  return (
    <section className='flex flex-col items-center w-screen max-w-2xl'>
      {items.content.length === 0 ? (
        <EmptyRepertory />
      ) : (
        <>
          <article className='flex justify-between w-full'>
            <h1 className='text-3xl font-semibold font-mono max-sm:text-2xl'>Listado</h1>
