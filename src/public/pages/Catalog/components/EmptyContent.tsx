        ...
        {classificationSelected !== 'ALL' ? (
          <>
            ...
            <p className='text-sm max-sm:text-xs text-center font-light'>
              ...
              {translateClassification(classificationSelected)}, puede intentar seleccionando otra
          ...
          <>
            ...
            <p className='text-sm max-sm:text-xs text-center font-light'>
              Lo sentimos, actualmente no tenemos plantines en nuestro cat&aacute;logo del vivero.
              Por favor, regresa m&aacute;s tarde.
            </p>
          </>
        )}
      </figure>
