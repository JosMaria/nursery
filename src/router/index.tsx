...
// const TestPlantPage = lazy(() => import('../pages/Plant/PlantPage'));

// import CreatePlantView from '../pages/Plant/views/CreatePlant/CreatePlantView';
// import ListPlantsView from '../pages/Plant/views/List/ListView';
